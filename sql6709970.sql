...
--
-- Host: localhost    Database: sql6709970
-- ------------------------------------------------------
...
CREATE TABLE `history` (
  ...
  `id_instalasi` varchar(255) NOT NULL,
...
CREATE TABLE `instalasi` (
  ...
  `suhu_kabel` float DEFAULT NULL,
  `prediksi_tgl` varchar(255) NOT NULL,
  `tgl_pengecekan` date NOT NULL,
  `gambar_asli` varchar(255) DEFAULT NULL,
  `gambar_flir` varchar(255) DEFAULT NULL,
...
INSERT INTO `login` VALUES (43,'Ratu Sondang Elishabet Sidauruk','ratusondang5394@gmail.com','TAelish4'),(45,'Raudatul Hamidah','raudatul76hamidah@gmail.com ','TArara76');
...
-- Dump completed on 2024-07-30  0:50:09
